...
/** @var \App\models\subscriber\Subscriber $subscriber */
?>
...
@section('panel')
    ...
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">subscriber: <b>{{$subscriber->firstname}}</b></div>
            <div class="col-md-2 col-sm-3 col-xs-4">
                <div class="pull-right">
                    ...
                    {{ link_to_route('bunch.subscriber.edit', 'edit',
                        [$bunch, $subscriber->id], ['class' => 'btn btn-primary btn-xs']) }}
                    |
